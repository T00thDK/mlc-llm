...
Converts raw history + declared profile + feedback into an interpretable
weight dictionary consumed by the ranker.

Weight keys:
  genre:<name>, language:<code>, era:<decade>, platform:<name>, title:<key>
"""
